%% Part 2(d)
% In part 2(d), we are now investigating the difference between the current
% and various sigma for the box.

% Reset Everything
close all
clear

% Creating a loop for increaing the sigma size
for a = 1e-2:1e-2:0.9
...
%% Discussion
% The current density will increase proportionally with the increasing
% sigma of the box